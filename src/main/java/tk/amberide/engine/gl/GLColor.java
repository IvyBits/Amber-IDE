...
public class GLColor implements Serializable {
     ...
     */
    public static final GLColor YELLOW = new GLColor(1.0f, 1.0f, 0, 1.0f);
    /**
     * The fixed colour red
     */
    public static final GLColor RED = new GLColor(1.0f, 0, 0, 1.0f);
    /**
     * The fixed colour blue
     */
    public static final GLColor BLUE = new GLColor(0, 0, 1.0f, 1.0f);
    /**
     * The fixed colour green
     */
    public static final GLColor GREEN = new GLColor(0, 1.0f, 0, 1.0f);
    /**
     * The fixed colour black
     */
    public static final GLColor BLACK = new GLColor(0, 0, 0, 1.0f);
    /**
     ...
     */
    public static final GLColor CYAN = new GLColor(0, 1.0f, 1.0f, 1.0f);
    /**
     * The fixed colour dark gray
     */
    public static final GLColor DARK_GRAY = new GLColor(0.3f, 0.3f, 0.3f, 1.0f);
    /**
     * The fixed colour light gray
     */
    public static final GLColor LIGHT_GRAY = new GLColor(0.7f, 0.7f, 0.7f, 1.0f);
    /**
     * The fixed colour dark pink
     */
    public final static GLColor PINK = new GLColor(255, 175, 175, 255);
    /**
     * The fixed colour dark orange
     */
    public final static GLColor ORANGE = new GLColor(255, 200, 0, 255);
    /**
     * The fixed colour dark magenta
     */
    public final static GLColor MAGENTA = new GLColor(255, 0, 255, 255);
    /**
...
* @return The darker version of this colour
     ...
     * Make a darker instance of this colour
     *     
* @param scale The scale down of RGB (i.e. if you supply 0.03 the colour
     * will be darkened by 3%)
     * @return The darker version of this colour
     */
...
* @param c The colour to add
     ...
     */
    public GLColor addToCopy(GLColor c) {
...
* @param value The value to scale by
     ...
     */
    public GLColor scaleCopy(float value) {
        GLColor copy = new GLColor(r, g, b, a);
        copy.r *= value;
        copy.g *= value;
        copy.b *= value;
