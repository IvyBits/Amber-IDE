...
public class OggDecoder {
     ...
     */
    public int channels;
    public Stream oggInput;

    /**
     * Create a new OGG decoder
     */
    public OggDecoder(InputStream input) throws IOException {
        ByteArrayOutputStream dataout = new ByteArrayOutputStream();

        oggInput = new Stream(input);
        ...
        data = ByteBuffer.allocateDirect(bytes.length).put(bytes);
        data.rewind();
    }
    ...
    public class Stream extends InputStream {
         ...
         * @throws IOException Indicates a failure to read from the supplied
         * stream
         */
        public Stream(InputStream input) throws IOException {
            this.input = input;
        ...
        /**
         * Initialise the streams and thread involved in the streaming of OGG
         * data
         *
