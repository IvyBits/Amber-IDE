            ...
            for (int y = y1; y < y2; y++) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (t != null) {
                        ...
                        int dx = x * 32;
                        int dy = context.map.getLength() * 32 - y * 32 - 32;
    ...
    protected void drawGrid(Graphics2D g, int x1, int y1, int x2, int y2) {
        ...
        if (cursorPos != null) {
            ...
            if (size.height > 0 && size.width > 0)
                g.drawRect(cursorPos.x * 32, context.map.getLength() * 32 + 32 - cursorPos.y * 32 - size.height * 32, size.width * 32, size.height * 32);
        }
